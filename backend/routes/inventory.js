...
async function sendMail(user, callback) {
    ...
    <h2>So we (Oil Stock Managment would like to request ${user.quantityNumber} amount of units from ${user.name} )</h2><br>
    ...
    <h3>Info* : </h3>
    <h4>If there is any issue reagrding the oder please be free to contact us or email us (ganeshnv0.contactus@gmail.com) 😃 </h4>
    </body>
    `
    };
...
async function sendmailOutOfStock(user, callback) {
    ...
    <body>
    <h1>Dear Supplier </h1><br>
    <h3>Our current OIL  stock of ${user.name} has been finished/Out of stock</h3><br>
    <h2>So we (Inventory Managment would like to request ${user.quantityNumber} amount of units from ${user.name} )</h2><br>
    <h3>Please reply back if the this oder is verified.</h3>
